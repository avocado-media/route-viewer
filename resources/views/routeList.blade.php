...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        .badge--get { @apply bg-[#42AAF8]; }
        .badge--post { @apply bg-[#1AC05D]; }
        .badge--put { @apply bg-[#FFA101]; }
        .badge--delete { @apply bg-[#FC4B4F]; }
        .badge--patch { @apply bg-[#FFA101]; }
        .badge--head { @apply bg-[#D58047]; }
    </style>
</head>
        ...
        <section>
            <div class="flex justify-between mb-4">
                ...
                <div class="relative max-w-xs w-full flex items-center ring-1 rounded-lg ring-slate-500">
                    <input type="text" name="search" placeholder="Search..." class="block w-full rounded-md bg-transparent border-0 pr-12 shadow-sm focus:ring-0 sm:text-sm">
